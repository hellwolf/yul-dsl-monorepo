...
{- * Num instances for (Yul'L  r) -}

instance {-# OVERLAPPABLE #-} (YulNum a, YulObj r) => Additive (P'L v r a) where
  a + b = encode YulNumAdd (merge (a, b))

instance {-# OVERLAPPABLE #-} (YulNum a, YulObj r) => AddIdentity (P'L v r a) where
...
instance {-# OVERLAPPABLE #-} (YulNum a, YulObj r) => AdditiveGroup (P'L v r a) where
